...
class Boat(models.Model):
    ...
    lake = models.CharField(null=True, max_length=100)
    picture = models.CharField(null=True, max_length=255)
    boat_rating = models.DecimalField(null=True, max_digits=3, decimal_places=2)
    boat_type = models.CharField(null=True, max_length=100)
